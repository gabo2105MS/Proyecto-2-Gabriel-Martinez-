...
private static MonticuloBinario cola;
     ...
     * @param monticulo
     */
    public EliminarUser(Hastable hastable, Cronometro crono, MonticuloBinario monticulo) {
        hash = hastable;
        crono = c;
        cola = monticulo;
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(nombreUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 140, 340, 50));
    ...
    private void Aceptar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Aceptar1ActionPerformed
        if(hash.usuarioPresente(nombreUser.getText())){
            hash.eliminar(nombreUser.getText().toLowerCase());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarUser(hash, c, cola).setVisible(true);
            }
        });
    }
